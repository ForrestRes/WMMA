...
public class MainPageWorker extends AsyncTask<String, Void, String> {

    Context context;
    MainPageActivity activity;
    String type;

    MainPageWorker(Context ctx, MainPageActivity a){
        context = ctx;
        activity = a;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        String main_initialize_url = "http://192.168.0.13/WMMA/mainInitialize.php/";
        String result = "";

        if(strings[0].equals("initialize")){
            type = "initialize";
            try {
                URL url = new URL(main_initialize_url);
